            ...
            success : function(data) {  //data为成功后返回数据
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    row.innerHTML="<td style='text-align:left; padding-left:20px;'><input type='checkbox' name='id[]' value='' />"+data[i][0].username+"</td> " +
                            ...
                            " <td>2016-07-01</td>"+
                            "<td><div class='button-group'> <a class='button border-main' href='add.html'><span class='icon-edit'></span>详情</a> <a class='button border-red' href='javascript:void(0)' onclick='return del(1,1,1)'><span class='icon-trash-o'></span> 删除</a> </div></td>"
                }
            }
        });

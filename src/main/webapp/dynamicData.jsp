                    ...
                    <div class="row">              <!--显示统计信息-->
                        <div class="ibox float-e-margins col-lg-12">
                            ...
                            <div class="ibox-content">
                                ...
                                <form role="form" class="form-inline" style="margin-bottom: 1em">


                                    <button class="btn btn-primary dim" style="margin-top: 3em !important;"
                                            type="button" id="button_evaluate">开始评估！
                                    </button>
                                </form>
                                <p id="status"></p>
                            </div>

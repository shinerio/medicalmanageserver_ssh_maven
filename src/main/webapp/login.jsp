...
<div class="middle-box text-center loginscreen animated fadeInDown" style="width: 30%">
    <div>
        ...
        <h3>欢迎来到HP+</h3>
        <form class="m-t" role="form" action="${pageContext.request.contextPath}/doctor/login.action" method="post">
            ...
            <button type="submit" class="btn btn-primary block full-width m-b btn-lg">登录</button>
        </form>
